...
export function SignIn(){
    ...
    async function handleSignInWithGoogle() {
        try{
            ...
            console.log(error);
            Alert.alert('Não foi possível usar a conta Google')
        }finally{
            setIsLoading(false);
        }
    }
    async function handleSignInWithApple() {
        try{
            ...
            console.log(error);
            Alert.alert('Não foi possível usar a conta Apple')
        }finally{
            setIsLoading(false);
        }
    }
    return (
        <Container>
            ...
            <Footer>
                ...
                {isLoading && <ActivityIndicator color={theme.colors.primary} style={{marginTop:18}}/>}
            </Footer>
        </Container>
    );
}